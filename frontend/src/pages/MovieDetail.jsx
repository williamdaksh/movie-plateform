...
const MovieDetail = () => {
  ...
  const { detail, videos, cast, detailLoading } = useSelector(
    (state) => state.movies
  );

  useEffect(() => {
    console.log('Fetching:', type, id); // check karo
...
if (detailLoading) return (
  ...
  if (!detail)
    return <h2 style={styles.center}>Movie nahi mili 😕</h2>;
      ...
      <div style={styles.hero}>
        ...
        <div style={styles.info}>
          ...
          <p style={styles.overview}>
            {detail.overview || 'Description available nahi hai.'}
          </p>
