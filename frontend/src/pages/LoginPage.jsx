      ...
      <div className="auth-right" style={styles.right}>
        <div className="auth-form" style={styles.formWrapper}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20, marginBottom: 28 }}>
            {/* Email */}
            <div>
              <label style={{ ...styles.label, color: focused === 'email' ? '#C9A84C' : '#8A7E6F' }}>
                Email Address
              </label>
              <input
            ...
            {/* Password */}
            <div>
              <label style={{ ...styles.label, color: focused === 'password' ? '#C9A84C' : '#8A7E6F' }}>
                Password
              </label>
          ...
          <p style={{ textAlign: 'center', color: '#7A6E5F', fontSize: 14, fontFamily: "'DM Sans', sans-serif" }}>
            ...
            <Link to="/signup" style={{ color: '#C9A84C', textDecoration: 'none', fontWeight: 600 }}>
              Create one →
            </Link>
          </p>
          ...
          <p style={{ textAlign: 'center', marginTop: 16 }}>
            <Link
              to="/"
              style={{ color: '#504840', fontSize: 13, fontFamily: "'DM Sans', sans-serif", textDecoration: 'none', letterSpacing: '0.5px' }}
